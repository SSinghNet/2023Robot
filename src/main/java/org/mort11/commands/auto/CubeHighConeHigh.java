	...
	public CubeHighConeHigh(boolean isBluee) {
		...
		addCommands(new InstantCommand(() -> drivetrain.resetPose(0, 0, 0)),
				...
				new ParallelCommandGroup(
						new SequentialCommandGroup(new MoveToAprilTag(isBluee ? 6 : 3).withTimeout(1.5),
				...
				new ParallelCommandGroup(new SetArm(Constants.Arm.SCORING_POSITION), new TimedDrive(1, -0.3, 0, 0)),
				new SetClawPiston(true), new TimedIntake(0.2, false, false), new SetArm(Constants.Arm.REST_POSITION),
