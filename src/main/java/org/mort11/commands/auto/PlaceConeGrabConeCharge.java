...
public class PlaceConeGrabConeCharge extends SequentialCommandGroup {
	...
	public PlaceConeGrabConeCharge() {
		...
		addCommands(new InstantCommand(() -> drivetrain.resetPose(0, 0, 0)), new ScoreCone(),
				...
				new ParallelDeadlineGroup(
						new SequentialCommandGroup(new MoveToPos(0, isBlue * Units.inchesToMeters(43), 0),
								new MoveToPos(Units.inchesToMeters(200), 0, 0),
								new MoveToPos(Units.inchesToMeters(6), 0, 0)),
						new SequentialCommandGroup(SetArmAndElevator.rest(), new SetClawPiston(true),
								SetArmAndElevator.floor(), new TimedIntake(5, true, true))),
				new TimedIntake(0.5, true, true), new SetClawPiston(false), new WaitCommand(0.2),

				new ParallelCommandGroup(new TimedIntake(2, true, true),
						new InstantCommand(() -> Wrist.getInstance().setSetpoint(Constants.Wrist.RIGHT_POSITION)),
						new SetArm(Constants.Arm.REST_POSITION),
						new SequentialCommandGroup(new TimedDrive(1, -1.5, isBlue * -1.75, 0),
								// new MoveToPos(Units.inchesToMeters(-40), Units.inchesToMeters(-60), 0),
								new WaitCommand(0.1), new TimedDrive(1.45, -1.8, 0, 0)
		...
		// new SetClawPiston(false),
		// new InstantCommand(() ->
		// Wrist.getInstance().setSetpoint(Constants.Wrist.RIGHT_POSITION)),
		// SetArmAndElevator.rest(),
		// SetArmAndElevator.middleNode()
		// ),
		// new SequentialCommandGroup(
