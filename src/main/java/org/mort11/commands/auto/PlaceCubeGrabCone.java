		...
		addCommands(
				...
				new ParallelDeadlineGroup(
                        new SequentialCommandGroup(
								...
								new MoveToPos(Units.inchesToMeters(185), 0, 0).withTimeout(3.5),
								new MoveToPos(Units.inchesToMeters(5), 0,0).withTimeout(1)
						),
						new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                    new ParallelCommandGroup(
                        ...
                        new SequentialCommandGroup(
                            new WaitCommand(0.5),
                            new MoveToPos(Units.inchesToMeters(-180), 0, 0).withTimeout(4)
                        )
                    ),
