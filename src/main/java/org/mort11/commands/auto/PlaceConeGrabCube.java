    ...
    public PlaceConeGrabCube() {
        ...
        addCommands(
            new InstantCommand(() -> drivetrain.resetPose(
                        new Pose2d(new Translation2d(0, 0), new Rotation2d(Math.toRadians(-10))))),
            new ClearArm(),
            ...
            new ParallelCommandGroup(
                ...
                new MoveToPos(new Transform2d(new Translation2d(
                        Units.inchesToMeters(218), 0), new Rotation2d(Math.toRadians(10)))) //227
                ),
